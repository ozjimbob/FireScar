...
pdf(file="Fig1.pdf",width=14,height=10)
...
# MFI 1
vars=c("MFI_10_T_2o","MFI_25_T_2o","MFI_50_T_2o","MFI_100_T_2o","MFI_250_T_2o","MFI_500_T_2o","MFI_census_2o","MFI_grid_2o")
this_frame=make_plot_frame(data_l1,vars,names)
...
# MFI 1
vars=c("MFI_10_T_10","MFI_25_T_10","MFI_50_T_10","MFI_100_T_10","MFI_250_T_10","MFI_500_T_10","MFI_census_10","MFI_grid_10")
this_frame=make_plot_frame(data_l1,vars,names)
...
### MFI 25
# MFI 1
vars=c("MFI_10_T_25","MFI_25_T_25","MFI_50_T_25","MFI_100_T_25","MFI_250_T_25","MFI_500_T_25","MFI_census_25","MFI_grid_25")
this_frame=make_plot_frame(data_l1,vars,names)
